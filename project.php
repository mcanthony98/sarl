            ...
            <div class="container">
                <div class="row g-4">
                    ...
                    ?>
                        ...
                        <div class="col-md-4">
                            <img src="uploads/<?php echo $imgrow['image'];?>" class="img-fluid rounded-3 gallery-img" style="height:150px;" alt="<?php echo $erow['title'];?> - <?php echo $counter;?>" data-bs-target="#imageModal" data-bs-toggle="modal" data-bs-index="<?php echo $counter;?>">
                        </div>
                    <?php } ?>
