...
<div class="wrapper">
  ...
  <div class="content-wrapper">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
                <div class="card card-secondary">
                    <div class="card-header">
                        <h3 class="card-title">Package image</h3>
    ...
    <form class="vstack gap-4 d-none" enctype="multipart/form-data" method="post" action="processes.php">
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <textarea class="form-control" rows="4" name="kw" placeholder="Enter Keywords">
                          <?php echo $row['seo_keywords'];?>
                        </textarea>
                    </div>
                    
                    <input type="hidden" name="elemid" value="<?php echo $sid;?>">
                                                    
                </div>
            </div>
            <div class="card-footer text-end">
                <button type="submit" name="seo-serv" class="btn btn-primary mb-0">Save Changes</button>
                </form>
            </div>
        </div>
        <!-- Cab Detail END -->
