            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <input class="form-control" type="text" name="tit" maxlength="60" value="<?php echo $row['seo_title'];?>" placeholder="Enter title" >
                    </div>

                    <!-- Desc -->
                    <div class="col-12">
                        <label class="form-label">SEO Page Description (Max 155 Characters)</label>
                        <textarea class="form-control" rows="4" name="desc" maxlength="155" placeholder="Enter Description"><?php echo $row['seo_description'];?></textarea>
                    </div>
